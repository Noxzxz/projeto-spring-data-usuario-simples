    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/matriculas/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/assinaturas/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/matriculas/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/usuarios/**").authenticated()
                .requestMatchers(HttpMethod.PUT, "/usuarios/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/usuarios/**").authenticated()
                .requestMatchers("/instrutor/**").hasRole("PROFESSOR")
                .requestMatchers(HttpMethod.GET, "/alunos/{id}/progresso").authenticated()
                .requestMatchers(HttpMethod.GET, "/gamificacao/moedas").authenticated()
